...
rebase-docker-image acehack/dotnet:2.0.5-sdk-powershell-2.1.4-nanoserver-sac2016 -t acehack/dotnet:2.0.5-sdk-powershell-rebase-2.1.4-nanoserver-1709 -b microsoft/nanoserver:1709
